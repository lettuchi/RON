...
label au_modern_case2_ferry_delay:
    ...
    $ show_cg_scene("au_modern_case2_ferry_deck", fade)
    pause 2.0
...
label au_modern_case2_airbnb_arrival:
    ...
    $ show_cg_scene("au_modern_case2_sofa_fort", fade)
    pause 2.0
...
label au_modern_case2_friend_texts:
    ...
    toa "I text: *not a date. contract says not romance on letterhead. send snacks.* She sends back *sure, Jan.* And she is not wrong. The contract says not romance on letterhead, and the contract is the most romantic thing anyone has ever written about me. That is the whole joke. We file it as procedure so we never have to call it the thing it plainly is."
...
label au_modern_case2_rider_menu:
    ...
    "The bed is one surface. The contract is another. Toa stands in the doorway like a woman who has read the rider twice and still wants a third"
...
label au_modern_case2_rider_intimate:
    ...
    "Rain writes shorthand on the window. His blazer folds over the chair like a man off duty for the night. Her tracksuit jacket follows. Shirt sleeves, charcoal trousers, the deputy reduced to breath and hands."
    ...
    "He maps her body the way he maps queue numbers: thorough, unhurried, mouth and hands and the patience he usually spends on citations, denying her the performance of shame."
    ...
    "When she trembles under his mouth, he steadies her with his palm at her hip and says acceptable noise is still noise. The audit moves from mouth to joined bodies, counted and unhurried, until the harbor rain is the loudest thing left in the room."
    $ show_cg_scene("au_modern_case2_rider_steady", dissolve)
    pause 1.0

    voice "audio/voice/narrator_585.mp3"
    "After, they lie tangled in the sheets, breath slowing, the exclusive rider finally spent."
...
label au_modern_case2_balcony_audit:
    ...
    "Sunday night finds them on the balcony, the weekend almost filed, harbor lights smeared across the rail and a tablet open to the municipal portal where Tuesday"
    ...
    toa "Dependent. Signatory. Two boxes on one form, and a camera that turned them into a couple. I did not understand that my right to dance in this port was also your liability until you"
    $ show_cg_scene("au_modern_case2_balcony_studio_talk", dissolve)
    pause 1.0

    voice "audio/voice/toa_505.mp3"
    toa "I keep thinking about the studio."
    voice "audio/voice/toa_506.mp3"
    toa "The afternoon you put down the clipboard and played the piano so I could take class."
    voice "audio/voice/toa_507.mp3"
    toa "You stopped counting and started listening,"
    voice "audio/voice/toa_508.mp3"
    toa "and you have been a different kind of careful with me ever since."
    voice "audio/voice/toa_509.mp3"
    toa "That is also not on any letterhead. I checked the file twice."

    voice "audio/voice/kaoru_621.mp3"
    kaoru "The piano is not in the record. Neither is the reason I sat down at it."
    voice "audio/voice/kaoru_622.mp3"
    kaoru "Some deliverables I keep in the drawer with no label,"
    voice "audio/voice/kaoru_623.mp3"
    kaoru "where the board cannot ask me to explain them. You are filed in that drawer."
    voice "audio/voice/kaoru_624.mp3"
    kaoru "So is the afternoon."
