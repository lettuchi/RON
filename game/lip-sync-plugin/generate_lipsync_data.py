...
def generate_lipsync_data(character_dir, audio_file):
    ...
    # Download from https://github.com/DanielSWolf/rhubarb-lip-sync/releases — see docs/lip-sync-setup.md
    # macOS (upstream default):
    rhubarb_path = os.path.join(script_dir, "Rhubarb-Lip-Sync-1.13.0-macOS", "rhubarb")
    # Windows example (uncomment and comment macOS line):
