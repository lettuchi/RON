...
label au_modern_wrong_floor_start:
    ...
    "The Arts Council is the body that decides who gets to make art in this port and who only gets the queue. It funds the performing-arts sponsorships, licenses the venues and storefronts, and streams its hearings straight onto the public record. A sponsorship is the Council's permission slip: with one, a transfer dancer may legally rehearse, perform, be paid, and stay. Without one she is a tourist with good posture and a packet six weeks expired."
    $ show_cg_scene("au_modern_rain_parking", fade)
    pause 1.0

    voice "audio/voice/narrator_480.mp3"
    "The Crane Conservatory had sent her off with a transfer letter and a stamp case."
    voice "audio/voice/narrator_481.mp3"
    "It had not sent her a patron, a roommate with pull,"
    voice "audio/voice/narrator_482.mp3"
    "or a name anyone on floor fourteen B would recognize."
    voice "audio/voice/narrator_483.mp3"
    "Ryoko Port is a city of introductions, and she had none. No gallery owner waiting at the tram."
    voice "audio/voice/narrator_484.mp3"
    "No company director who owed the Conservatory a favor."
    voice "audio/voice/narrator_485.mp3"
    "No aunt in the ward office, no ex-classmate on the Council payroll."
    voice "audio/voice/narrator_486.mp3"
    "Just talent, paperwork, and a permit date the calendar had already crossed out."

    voice "audio/voice/narrator_487.mp3"
    "A performing-arts sponsorship from the Arts Council is the only fast path the port offers a"
    voice "audio/voice/narrator_488.mp3"
    "transfer dancer who arrives without institutional backing. Intake can queue you."
    voice "audio/voice/narrator_489.mp3"
    "A clerk can circle your expiration date in red."
    voice "audio/voice/narrator_490.mp3"
    "Only a deputy director in the Office of Arts and Licensing can sign the sponsorship and make"
    voice "audio/voice/narrator_491.mp3"
    "you legal again."
    voice "audio/voice/narrator_492.mp3"
    "She needed a signatory of record before the port decided she had overstayed her welcome."
...
label au_modern_wrong_door:
    ...
    menu au_modern_door_menu:
        ...
        "Knock again, properly this time.":
            ...
            $ show_cg_scene("au_modern_wf_knock", fade)
            pause 2.0
...
label au_modern_permit_crisis:
    ...
    $ show_cg_scene("au_modern_wf_revise_agenda", fade)
    pause 1.0
...
label au_modern_studio_audition:
    ...
    kaoru "Counting is witness work. Stop expecting applause from a licensing officer. I will say one thing for the record and deny it under oath later. You stopped apologizing on the second pass. That is discipline, not charm. Discipline is the one thing in this building I respect without a form ordering me to."
    ...
    voice "audio/voice/narrator_493.mp3"
    "He does not owe her a signature."
    voice "audio/voice/narrator_494.mp3"
    "The queue is full of applicants with expired packets and better connections than hers."
    voice "audio/voice/narrator_495.mp3"
    "He could have sent her back to intake and let the board eat her on the public record she had"
    voice "audio/voice/narrator_496.mp3"
    "already walked into."
    voice "audio/voice/narrator_497.mp3"
    "Instead he is preparing to sign, because the studio proved what the packet could not,"
    voice "audio/voice/narrator_498.mp3"
    "and because a deputy who vouches for talent the Council has not yet met is doing the job the"
    voice "audio/voice/narrator_499.mp3"
    "fast track was always supposed to do. The bureaucratic lifeline is not kindness."
    voice "audio/voice/narrator_500.mp3"
    "It is jurisdiction with a chop on it."
...
label au_modern_contract_menu:
    ...
    "Back in the licensing office, the audition behind her, the sponsorship draft waits on his desk. His signature is ready. The only thing still hers to decide is which rider hangs off it. The sponsorship itself is the permission: the Arts Council authorizes her to work as a performing artist in the port, and his chop on the form tells the board she will not embarrass the seal that funds her. That part is already decided. The riders are what hang off the permission and tell the office how she and the deputy who signed her are allowed to occupy the same building afterward."
    ...
    "The sponsorship itself is plain enough once someone explains the boxes. The Arts Council authorizes her to work as a performing artist in the port, and the deputy director's signature on the form vouches to the Council that she will not embarrass the seal that funds her. The riders do not change that. They only decide how close the deputy who signed it has to stand while his name is the one on the permit. Both riders carry the same fine print, the witness clause: a fast-tracked artist must attend the deputy's inspections and document living proof for the Council that he does not hand permits to dancers he happens to favor. She does not learn what that costs until later. Today it is only a line she initials. The standard performance rider is the distant one: scheduled compliance reviews during business hours, discretion about municipal accounts, no city seal cropped into a meme. The witness clause still applies: she documents his inspections on the record so the Council can see he is not inventing dancers or playing favorites. Independence stays intact. Proximity stays professional. The queue remembers you as an artist who filed boring paperwork and kept her distance. The exclusive rehearsal sponsor rider is the close one: after-hours studio access when the public rooms go dark, direct deputy review instead of a rotating auditor. Calendar integration, which is bureaucratese for his schedule and hers sharing cells the intake counter never sees. The same witness clause, same favoritism insurance, but the inspections and the rehearsals and the logged hours pile up beside his name. Proximity becomes procedure. Procedure becomes the only language the port allows for wanting someone without filing romance on letterhead. One rider keeps her at arm's length from the man whose signature lets her stay. The other puts her on his calendar and in his after-hours rooms. Both keep her legal. Only one decides whether distance is a comfort or a cost."
    menu au_modern_contract_choices:
        ...
        "Standard performance rider (professional terms).":
            ...
            kaoru "Correct. Boring is enforceable. I can work with boring. She initials the witness clause and files the rest under professional distance. The sponsorship will clear. The inspections will still find her."

            voice "audio/voice/narrator_479.mp3"
            "She will document what he points at and keep her name off his calendar except where the clause requires it. Independence, bought with boredom and a stamp."
        ...
        "Exclusive rehearsal sponsor (after-hours access).":
            ...
            kaoru "You understand that clause includes my calendar, not romance on letterhead. Hear the word I used. *Not.* On letterhead would mean I filed us. Your name beside mine, a relationship of record, a thing the Council can open and read and rule on. The rider is the opposite of that. Calendar, clause, after-hours access. We keep the real word out of every box a clerk could subpoena, and we call the keeping-out a rider."
            $ show_cg_scene("au_modern_wf_pulse_read", fade)
            pause 1.0

            voice "audio/voice/toa_467.mp3"
            toa "I understand paperwork. I am very good at paperwork when someone explains the boxes. *Direct deputy review.* I read that line three times, and my pulse did something unprofessional each time. So that is the trick of the letterhead. We file the courtship as procedure precisely so neither of us has to admit it is one. The clause is the flirting. The filing is the romance. I will not put that in writing. I am, as you keep noting, very good at not putting things in writing."
            $ show_cg_scene("au_modern_phone_date", fade)
            pause 1.5

            voice "audio/voice/narrator_501.mp3"
            "She initials the witness clause and the calendar cells both. After-hours access. Direct review."
            voice "audio/voice/narrator_502.mp3"
            "His name beside hers in the portal where clerks can subpoena schedules but not feelings."
            voice "audio/voice/narrator_503.mp3"
            "Proximity filed as procedure. The port will call it sponsorship."
            voice "audio/voice/narrator_504.mp3"
            "She will learn to call it the only door that stayed open."
...
label au_modern_elevator_unless:
    ...
    "She does not pretend, afterward, that nothing happened between them. His mouth found hers against the rain-streaked glass. His hand learned her waist and stopped before the filing finished. Whatever the service lift was, every form that matters will still file it as sponsorship: after-hours rehearsal access, logged under the exclusive rider she signed with her eyes open. The seal stays professional on paper. The rest stays off the public record, which is exactly what that rider is for."
    ...
    "He brackets her against the glass once more, unfinished business and a promise to finish it"
    voice "audio/voice/narrator_506.mp3"
    "where no badge can call the car. The service lift goes dark on the rest."
...
label au_modern_signing:
    ...
    $ show_cg_scene("au_modern_wf_signing_effective", fade)
    pause 1.0

    voice "audio/voice/narrator_383.mp3"
    "The sponsorship contract returns to her tablet sleeve with a fresh effective date. Three business days. Not a love letter. Still binding. She reads the effective line twice because numbers are safer than whatever lives in her chest when he stands too close."
    ...
    if au_modern_contract_choice == "exclusive" and au_modern_unless_taken:
        ...
        "After hours, his office couch accepts two people who will sleep clothed under one blanket, still calling it sponsorship on every form that matters. Harbor lights smear across the window."
