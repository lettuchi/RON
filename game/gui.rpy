...
## text. Gold, Emerald Magistrate / otome title screen accent.
define gui.accent_color = "#c9a227"

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = "#b8a888"

## The small color is used for small text, which needs to be
## brighter/darker to achieve the same effect.
define gui.idle_small_color = "#9a9080"
...
define gui.text_color = "#f5f0e6"
define gui.interface_text_color = "#f5f0e6"
...
define gui.textbox_height = gui.scale(200)

## Opaque say-screen textbox (replaces semi-transparent gui/textbox.png).
define gui.textbox_background_color = "#131110"
define gui.textbox_border_color = "#c9a227"
define gui.textbox_border_height = gui.scale(2)

## Bust portrait slot inside the textbox (otome layout, see ui_layout.rpy).
define gui.side_image_xpos = gui.scale(16)
define gui.side_image_width = gui.scale(168)
define gui.side_image_height = gui.scale(168)
...
define gui.dialogue_ypos = gui.scale(52)
define gui.dialogue_xpos_narrator = gui.scale(36)

## The maximum width of dialogue text, in pixels.
define gui.dialogue_width = gui.scale(680)
## Full textbox inner width (symmetric side padding) for centered narrator lines.
define gui.dialogue_width_narrator = config.screen_width - 2 * gui.scale(36)
