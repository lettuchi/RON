...
init python:
    ...
    GALLERY_GROUPS = [
        ...
        (_("Extra: AU Wrong Floor (Modern)"), [
            ...
            # Pass 4 (2026-06-07): studio piano / ballet-class scene + black-screen cuts.
            GalleryCG(_("Studio & Piano (AU Case 1)"),
                      "images/cg/cg-au-modern-case1-studio-piano.png",
                      "cg au_modern_case1_studio_piano"),
            GalleryCG(_("Barre Two-Shot (AU Case 1)"),
                      "images/cg/cg-au-modern-case1-barre-twoshot.png",
                      "cg au_modern_case1_barre_twoshot"),
            GalleryCG(_("He Sits at the Piano (AU Case 1)"),
                      "images/cg/cg-au-modern-case1-piano-sit.png",
                      "cg au_modern_case1_piano_sit"),
            GalleryCG(_("Stopped Counting, Started Listening (AU Case 1)"),
                      "images/cg/cg-au-modern-case1-piano-lookup.png",
                      "cg au_modern_case1_piano_lookup"),
            GalleryCG(_("Reverence to the Accompanist (AU Case 1)"),
                      "images/cg/cg-au-modern-case1-reverence.png",
                      "cg au_modern_case1_reverence"),
            GalleryCG(_("Neon Wellness Corridor (AU Case 1)"),
                      "images/cg/cg-au-modern-case1-corridor-walk.png",
                      "cg au_modern_case1_corridor_walk"),
            GalleryCG(_("Filming the Inspection (AU Case 1)"),
                      "images/cg/cg-au-modern-case1-witness-film.png",
                      "cg au_modern_case1_witness_film"),
            GalleryCG(_("Knock, Properly (AU Wrong Floor)"),
                      "images/cg/cg-au-modern-wf-knock.png",
                      "cg au_modern_wf_knock"),
            GalleryCG(_("Revise the Agenda (AU Wrong Floor)"),
                      "images/cg/cg-au-modern-wf-revise-agenda.png",
                      "cg au_modern_wf_revise_agenda"),
            GalleryCG(_("Direct Deputy Review (AU Wrong Floor)"),
                      "images/cg/cg-au-modern-wf-pulse-read.png",
                      "cg au_modern_wf_pulse_read"),
            GalleryCG(_("Studio Key Handoff (AU Wrong Floor)"),
                      "images/cg/cg-au-modern-wf-studio-key.png",
                      "cg au_modern_wf_studio_key"),
            GalleryCG(_("Effective Date Signed (AU Wrong Floor)"),
                      "images/cg/cg-au-modern-wf-signing-effective.png",
                      "cg au_modern_wf_signing_effective"),
            GalleryCG(_("Ferry Deck Crossing (AU Case 2)"),
                      "images/cg/cg-au-modern-case2-ferry-deck.png",
                      "cg au_modern_case2_ferry_deck"),
            GalleryCG(_("Sofa vs Bed (AU Case 2)"),
                      "images/cg/cg-au-modern-case2-sofa-fort.png",
                      "cg au_modern_case2_sofa_fort"),
            GalleryCG(_("Rider, Steadied (AU Case 2)"),
                      "images/cg/cg-au-modern-case2-rider-steady.png",
                      "cg au_modern_case2_rider_steady"),
            GalleryCG(_("Balcony Studio Callback (AU Case 2)"),
                      "images/cg/cg-au-modern-case2-balcony-studio-talk.png",
                      "cg au_modern_case2_balcony_studio_talk"),
            GalleryCG(_("Two Folders (AU Case 3)"),
                      "images/cg/cg-au-modern-case3-hr-folders.png",
                      "cg au_modern_case3_hr_folders"),
            GalleryCG(_("Two Boxes, One Couple (AU Case 3)"),
                      "images/cg/cg-au-modern-case3-two-boxes.png",
                      "cg au_modern_case3_two_boxes"),
            GalleryCG(_("After-Hours Embrace (AU Case 3)"),
                      "images/cg/cg-au-modern-case3-after-hours-embrace.png",
                      "cg au_modern_case3_after_hours_embrace"),
            GalleryCG(_("Disclosure in His Own Hand, Writing (AU Case 3)"),
                      "images/cg/cg-au-modern-case3-disclosure-handwrite.png",
                      "cg au_modern_case3_disclosure_handwrite"),
            GalleryCG(_("Harbor Home Piano (AU Epilogue)"),
                      "images/cg/cg-au-modern-epilogue-harbor-piano.png",
                      "cg au_modern_epilogue_harbor_piano"),
            GalleryCG(_("Clementine Peel (AU Epilogue)"),
                      "images/cg/cg-au-modern-epilogue-clementine-peel.png",
                      "cg au_modern_epilogue_clementine_peel"),
            GalleryCG(_("Into the Curve (AU Epilogue)"),
                      "images/cg/cg-au-modern-epilogue-curve-pull.png",
                      "cg au_modern_epilogue_curve_pull"),
            GalleryCG(_("A Standing Item (AU Epilogue)"),
                      "images/cg/cg-au-modern-epilogue-standing-item.png",
                      "cg au_modern_epilogue_standing_item"),
            GalleryCG(_("Waiting Period, Objection (AU Epilogue)"),
                      "images/cg/cg-au-modern-epilogue-three-days-joke.png",
                      "cg au_modern_epilogue_three_days_joke"),
        ]),
