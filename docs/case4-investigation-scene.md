...
**Entry:** `case3_milestone_end` → `case3_post_case3_bridge` → (optional Case 3.5 `case3_5_is_this_a_date_interlude`) → `case4_post_case3_bridge` → `case4_investigation_start`  
...
| # | Beat | Visual |
|---|------|--------|
| 0 | Optional Case 3.5 date | `case3_5_is_this_a_date_interlude` (see `docs/case3.5-date-interlude-design.md`) |
| 1 | Bridge from Case Three / 3.5 | `case4_post_case3_bridge` |
