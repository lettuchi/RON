...
**Rescue (canon continue):** Finish Case 2 → festival/morning bridge → Case 3 → briefing → any clue → *Trust Kaoru* → `case3_milestone_end` → `case3_post_case3_bridge` (optional Case 3.5) → Case 4 dock.
