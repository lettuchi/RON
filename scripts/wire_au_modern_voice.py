#!/usr/bin/env python3
"""Wire Modern AU Wrong Floor voice lines into manifests."""
...
RPY = ROOT / "game" / "au_modern_wrong_floor.rpy"
            ...
            rows.append(
                {
                    ...
                    "character": char,
                    "game_text": text,
                    "file": "game/au_modern_wrong_floor.rpy",
                    "line": i,
                }
            )
            continue
...
def main() -> None:
            ...
            pm["entries"].append(
                {
                    ...
                    "game_text": game_text,
                    "tts_text": tts,
                    "tags_notes": "au modern wrong floor wire 2026-06-04",
    ...
    ids_path = ROOT / "scripts" / "au_modern_voice_ids.txt"
