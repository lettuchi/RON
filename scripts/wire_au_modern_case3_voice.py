#!/usr/bin/env python3
"""Wire Modern AU Case 3 Permits & HR voice lines into manifests."""
...
RPY = ROOT / "game" / "au_modern_case3_permits_hr.rpy"
            ...
            rows.append(
                {
                    ...
                    "character": char,
                    "game_text": text,
                    "file": "game/au_modern_case3_permits_hr.rpy",
                    "line": i,
                }
            )
            continue
...
def main() -> None:
            ...
            pm["entries"].append(
                {
                    ...
                    "game_text": game_text,
                    "tts_text": tts,
                    "tags_notes": "au modern case3 permits hr wire 2026-06-05",
    ...
    ids_path = ROOT / "scripts" / "au_modern_case3_voice_ids.txt"
