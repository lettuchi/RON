#!/usr/bin/env python3
"""Wire Modern AU Case 2 Island Weekend voice lines into manifests."""
...
RPY = ROOT / "game" / "au_modern_case2_island_weekend.rpy"
            ...
            rows.append(
                {
                    ...
                    "character": char,
                    "game_text": text,
                    "file": "game/au_modern_case2_island_weekend.rpy",
                    "line": i,
                }
            )
            continue
...
def main() -> None:
            ...
            pm["entries"].append(
                {
                    ...
                    "game_text": game_text,
                    "tts_text": tts,
                    "tags_notes": "au modern case2 island weekend wire 2026-06-04",
    ...
    ids_path = ROOT / "scripts" / "au_modern_case2_voice_ids.txt"
